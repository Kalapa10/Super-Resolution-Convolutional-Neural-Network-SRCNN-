...
Original file is located at
    https://colab.research.google.com/drive/113ktnVcLTyHcKJ_NElzSPQauEnydVD-Q
"""
...
encoded = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x6)
#x3 = Conv2D(3, (5, 5), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x2)
# decoding architecture
x7 = UpSampling2D()(encoded)
#x8 = Add()([x2, x7])
x9 = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x7)
x10 = Conv2D(64, (5, 5), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x9)
x11 = Add()([x5, x9])
x12 = UpSampling2D()(x11)
x13 = Conv2D(64, (5, 5), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x12)
x14 = Conv2D(32, (9, 9), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x13)
decoded = Conv2D(3, (3, 3), strides=(1,1), padding='same',activation='sigmoid', kernel_regularizer=regularizers.l1(10e-10))(x14)
srcnn_modif1_model = Model(Input_img, decoded)
srcnn_modif1_model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
srcnn_modif1_model.summary()
...
abcd = srcnn_modif1_model.fit(train_x_px,train_x, epochs=50, validation_data=(val_x_px, val_x), callbacks=[early_stopper, model_checkpoint])
