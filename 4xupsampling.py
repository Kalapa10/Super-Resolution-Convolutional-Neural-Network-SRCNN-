...
Original file is located at
    https://colab.research.google.com/drive/1lvejRU4P6-Nw6Jn4PavedNgI7RKIVnQ7
"""
...
x4 = Conv2D(64, (5, 5), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x3)
x5 = Conv2D(128, (3, 3), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x4)
x6 = MaxPool2D(padding='same')(x5)
x7 = Conv2D(64, (5, 5), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x6)
x8 = Conv2D(128, (3, 3), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x7)
x9 = MaxPool2D(padding='same')(x8)
x10 = Conv2D(64, (5, 5), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x9)
x11 = Conv2D(128, (3, 3), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x10)
x12 = MaxPool2D(padding='same')(x11)
encoded = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x12)
...
x14 = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x13)
x15 = Conv2D(64, (5, 5), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x14)
x16 = Add()([x11, x14])
x17 = UpSampling2D()(x16)
x18 = Conv2D(64, (5, 5), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x17)
x19 = Conv2D(32, (9, 9), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x18)
x20 = UpSampling2D()(x19)
x21 = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x20)
x22 = Conv2D(64, (5, 5), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x21)
x23 = Add()([x5, x21])
x24 = UpSampling2D()(x23)
x25 = Conv2D(64, (5, 5), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x24)
x26 = Conv2D(32, (9, 9), strides=(1,1), activation='relu', padding='same', kernel_regularizer=regularizers.l1(10e-10))(x25)
decoded = Conv2D(3, (3, 3), strides=(1,1), padding='same',activation='sigmoid', kernel_regularizer=regularizers.l1(10e-10))(x26)
srcnn_modif3_model = Model(Input_img, decoded)
srcnn_modif3_model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
srcnn_modif3_model.summary()
...
abcd = srcnn_modif3_model.fit(train_x_px,train_x, epochs=50, validation_data=(val_x_px, val_x), callbacks=[early_stopper, model_checkpoint])
